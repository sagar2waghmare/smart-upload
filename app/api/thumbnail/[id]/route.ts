...
export async function GET(
  ...
  try {
    const upstream = await getValidatedDriveThumbnail(id.trim());
    ...
    console.error("[thumbnail] Google Drive thumbnail failed", error instanceof Error ? error.message : "unknown");
